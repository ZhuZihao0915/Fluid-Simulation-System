...
namespace Glb {
    ...
    void FluidShadowMap::DrawCaustic(Camera* camera, GLuint vaoNull, const glm::mat4& model) {
        // 渲染焦散图
        glViewport(0, 0, mWidth, mHeight);
    ...
    void FluidShadowMap::CreateShaders() {
        ...
        std::string pointSpriteZValueVertPath = "E:/CG/FluidSimulationOnWeekend-master/code/Fluid3d/Shaders/PointSprite.vert";
        std::string pointSpriteZValueGeomPath = "E:/CG/FluidSimulationOnWeekend-master/code/Fluid3d/Shaders/PointSprite.geom";
        std::string pointSpriteZValueFragPath = "E:/CG/FluidSimulationOnWeekend-master/code/Fluid3d/Shaders/PointSpriteZValue.frag";
        ...
        std::string causticMapVertPath = "E:/CG/FluidSimulationOnWeekend-master/code/Fluid3d/Shaders/CausticMap.vert";
        std::string causticMapFragPath = "E:/CG/FluidSimulationOnWeekend-master/code/Fluid3d/Shaders/CausticMap.frag";
